<h1>Sommercamp – tre fede uger på højskole</h1>
            ...
            <div class="hojskole" id="ronde">
                ...
                <ul>
                    ...
                    <li>Engelsk</li>
                    <li>Matematik</li>
                    <li>Kommunikation og eksamensforberedelse</li>
                    <li>Historie</li>
                    <li>Samfundsfag og religionsmøde</li>
                </ul>
                <p><a href="<?php e(url('/ronde-sommercamp')); ?>">Læs om Sommercamp Rønde</a></p>
            </div>
            ...
            <div class="hojskole" id="egaa">
                ...
                <p><a href="<?php e(url('/euh-sommercamp')); ?>">Læs om Sommercamp Egå</a></p>
            </div>
            ...
            <div class="hojskole" id="vih">
                ...
                <p><a href="<?php e(url('/vih-sommercamp')); ?>">Læs om Sommercamp Vejle</a></p>
            ...
            <p>Du kan tilmelde dig sommercamp ved at kontakte den højskole, du gerne vil på.</p>