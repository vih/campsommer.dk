<?php
class Campsommer_Controller_Euh extends k_Controller
{
    function GET()
    {
        $this->document->title           = 'Egå Højskole - Bliv klar til en ungdomsuddannelse';
        $this->document->description     = 'Sommercamp: Tre forrygende højskoleuger sammen med andre unge inden du starter på en uddannelse.';
    ...
    {
        return '<h2>Læs mere</h2><p><a href="http://www.euh.dk/">www.euh.dk</a></p>';
    }
}
